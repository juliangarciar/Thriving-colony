...
namespace aabb
{
	/**Ray**/
	struct Ray {
        /// Start of the line in each dimension.
        glm::vec3 rayStart;

        /// End of the line in each dimension.
        glm::vec3 rayEnd;

        /// Direction of the line in each dimension.
        glm::vec3 rayDirection;

        /// InverseDirecion of the line in each dimension.
    ...
    public:
         ...
         */
        glm::vec3 computeCentre();

        //! Compute the extent of the AABB.
        /*! \returns
                The position vector of the AABB extent.
         */
        glm::vec3 computeExtent();
    ...
    public:
        ...
        /*! \param skinThickness_
            ...
            \param nParticles
                The number of particles (for fixed particle number systems).
         */
        Tree(double, const std::vector<bool>&, const glm::vec3&, unsigned int nParticles = 16);
        ...
        /*! \param boxSize_
                The size of the simulation box in each dimension.
         */
        void setBoxSize(const glm::vec3&);
         ...
         */
        void insertParticle(unsigned int, glm::vec3&, double);
        ...
        /*! \param index
            ...
            \param upperBound
                The upper bound in each dimension.
         */
        void insertParticle(unsigned int, glm::vec3&, glm::vec3&);
         ...
         */
        bool updateParticle(unsigned int, glm::vec3&, double);
         ...
         */
        bool updateParticle(unsigned int, glm::vec3&, glm::vec3&);
        ...
        //! Query the tree to find candidate interactions for an Ray.
        /*! \param particle
                The particle index.
            ...
            \return particles
                A vector of particle indices.
         */
        std::vector<unsigned int> query(unsigned int, const Ray&);
        ...
        /*! \param ray
            ...
            \return particles
                A vector of particle indices.
         */
        std::vector<unsigned int> query(const Ray&);
    ...
    private:
        ...
        /* \param position
                The position vector.
         */
        void periodicBoundaries(glm::vec3&);
         ...
         */
        bool minimumImage(glm::vec3&, glm::vec3&);
    };
}
