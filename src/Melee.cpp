...
Melee::Melee(int id, SceneNode *layer, Enumeration::UnitType::SubClass unitData, Vector3<float> vectorData, Enumeration::Team teamData) : Unit(id, layer, vectorData, teamData)
{
    int metalCost = 0;
    int crystalCost = 0;
    int happiness = -10;
